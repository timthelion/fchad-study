...
Četl správně až na `e'.  Ho zřejmě zmátl, to že body nespadnou samo. Kvůli nekvalitě nahrávky nevím co odhadl ale říkal \uv{nějaké body} a jsem odpověděl \uv{ano, nepadnou když netlačíte na ně}.  Zřejmě už sledoval slova, protože potom co přečetl \uv{teď} po jednotlivých písmenech, říkal \uv{teď}.
...
Kdy dorazil na datum, říkal \uv{předpokládám, že to asi bude číslo    jedna devět   to znamená devatenáct set třináct}. Četl zbytek správně.

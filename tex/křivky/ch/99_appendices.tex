...
\pagenumbering{Roman}
\thispagestyle{empty}
\renewcommand{\appendixname}{Apendix}%%přílohy, číslování římskými
...
\addcontentsline{toc}{section}{A1   Technické detaily}
...
\addcontentsline{toc}{section}{A2   Obrazky FCHADu}
...
\section*{A3 Texty}
\addcontentsline{toc}{section}{A3   Texty}
\subsection*{A3.1 Tisknutý text}
\addcontentsline{toc}{subsection}{A3.1   Tisknutý text}
\begin{verbatim}
...
\clearpage
\subsection*{A3.2 Text na FCHAD}
\addcontentsline{toc}{subsection}{A3.2   Text na FCHAD}
\begin{multicols}{3}
\begin{verbatim}
Braills
ký řádek, kt

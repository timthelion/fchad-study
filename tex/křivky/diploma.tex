...
\newcommand{\KeywordsEn}{Refreshable braille displays, Braille, Textual output, Learning curves}
\newcommand{\KeywordsCs}{Braillský řádek, Braillovo písmo, čtení textového výstupu, křivka učení}

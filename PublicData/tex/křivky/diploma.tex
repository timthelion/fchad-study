...
%<------------------------------ headers ------------------------------------>
\newcommand{\SubjectCs}{Bakala\v{r}sk\'{a} Prace}
\newcommand{\TitleCs}{K\v{r}\'{i}vky u\v{c}en\'{i} v ran\'{e}m stadia u\v{c}en\'{i}, anebo setk\'{a}n\'{i} \v{c}lov\v{e}ka s ciz\'{i}m nastrojem.}
...
\newcommand{\KeywordsCs}{K\v{r}\'{i}vky u\v{c}en\'{i}, Braillové pismo, rychlost čtení}
\newcommand{\AuthorName}{Timothy Vladim\'{i}r Hobbs}
\newcommand{\SupervisorName}{Ing. Karolina Duschinsk\'{a}, Ph.D.}
...
\includegraphics[width=0.3\textwidth]{uk}\vspace{15mm}
